...
export default async function PinjamanProduktif() {
  ...
  const [pinjaman] = await Promise.all([
    getPinjamanById(noAnggota, "PRODUKTIF"),
  ]);

  if (!pinjaman.ok || !pinjaman.data) {
    return RenderError("Pinjaman Produktif", LABEL.ERROR.DESCRIPTION);
  }
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
      <div className="text-2xl font-medium">Pinjaman Produktif</div>
