...
export default async function PinjamanBarangAnggota() {
  const [pinjaman] = await Promise.all([getPinjaman("BARANG")]);

  if (!pinjaman.ok || !pinjaman.data) {
    return RenderError("Pinjaman Barang Anggota", LABEL.ERROR.DESCRIPTION);
  }
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
      <div className="text-2xl font-medium">Pinjaman Barang Anggota</div>
